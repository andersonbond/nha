...
function payloadFromBeneficiary(b: Beneficiary) {
  return {
    ...
    province_code: b.province_code || null,
    municipal_code: b.municipal_code || null,
    barangay_code: b.barangay_code || null,
    district_code: b.district_code || null,
