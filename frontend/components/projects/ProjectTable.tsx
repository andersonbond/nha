                ...
                <td className="relative whitespace-nowrap px-4 py-3 text-right">
                  <div className="flex justify-end gap-1">
                    <button
                      ...
                      className="rounded p-1.5 text-[var(--foreground)]/70 hover:bg-primary/10 hover:text-primary"
                    ...
                    <button
                      ...
                      className="rounded p-1.5 text-[var(--foreground)]/70 hover:bg-red-500/10 hover:text-red-600"
